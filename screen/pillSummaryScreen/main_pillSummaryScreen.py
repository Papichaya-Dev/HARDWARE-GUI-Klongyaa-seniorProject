...
class PillSummaryScreen(QDialog):
    def __init__(self):
        ...
        self.show_pill_name.setText(pill_data[0]["pill_name"])
        self.show_total_pills.setText(str(message_total_pills) + unit_pill)
        self.show_amount_pill.setText(str(message_amount_pill) + unit_pill)
        self.show_time.setText(str(message_time) + unit_time)
