...
class DetailScreen(QtWidgets.QDialog):
    ...
    def retranslateUi(self, detailScreen):
        ...
        # self.label_time_no_0.setText(_translate("detailScreen", "เวลาที่ 2"))
        # self.label_time_no_1.setText(_translate("detailScreen", "เวลาที่ 1"))
        ...
        # self.data_time_0.setText(_translate("detailScreen", "12.00 น."))
        # self.data_time_1.setText(_translate("detailScreen", "13.00 น."))
