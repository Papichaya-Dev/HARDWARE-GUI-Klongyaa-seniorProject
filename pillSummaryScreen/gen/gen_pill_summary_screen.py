...
class Ui_pill_summary_screen(object):
    def setupUi(self, background_summary_screen):
        ...
        background_summary_screen.resize(947, 601)
...
"")
        ...
        self.scroll_area.setStyleSheet("background-color:rgb(143, 182, 255);\n"
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 902, 402))
...
"color: #070021;")
        self.show_time_2.setOpenExternalLinks(False)
        self.show_time_2.setObjectName("show_time_2")
        self.gridLayout_2.addWidget(self.show_time_2, 13, 1, 1, 1)
...
"background-color:#C5E1FF;")
        ...
        self.gridLayout_2.addWidget(self.question_time_no2, 13, 0, 1, 1)
...
"")
        ...
        self.mock_button_edit_time = QtWidgets.QToolButton(self.scrollAreaWidgetContents)
        self.mock_button_edit_time.setMinimumSize(QtCore.QSize(70, 70))
        self.mock_button_edit_time.setStyleSheet("QToolButton#mock_button_edit_time {\n"
"   font-size: 40px;\n"
"  background-color: rgb(255, 74, 74);\n"
"  border-radius: 35px;\n"
"  color: white;\n"
"}\n"
"QToolButton#mock_button_edit_time {\n"
"    font-size: 40px;\n"
"  background-color: rgb(255, 50, 50);\n"
"  border-radius: 35px;\n"
"  color: white;\n"
"}")
        self.mock_button_edit_time.setObjectName("mock_button_edit_time")
        self.gridLayout_2.addWidget(self.mock_button_edit_time, 13, 3, 1, 1)
...
"background-color: #C5E1FF;")
    ...
    def retranslateUi(self, background_summary_screen):
        ...
        self.show_time_2.setText(_translate("background_summary_screen", "18.00"))
        self.question_time_no2.setText(_translate("background_summary_screen", "เวลาที่ 2"))
        ...
        self.mock_button_edit_time.setText(_translate("background_summary_screen", "🖉"))
